    ...
    <main>
        ...
        <form action="" class="form" method="POST">
            <div class='form-input'>
                <label for='judul-label'>Judul</label>
                <input type='text' name="judul" placeholder='Masukkan Judul' class='form-input-size' required
                    id="judul-label" value="<?=$data['judul'] ?>"/>
            </div>
            <div class='form-input'>
                <label for='content-label'>Content</label>
                <!-- <input type='text' name="content" placeholder='Masukkan Email' class='form-input-size' required
                    id="email-label" /> -->
                <textarea name="content" placeholder='Masukkan Judul' class='form-input-size' required id="content-label"  rows="7"><?= $data['content']; ?>
                </textarea>
            </div>

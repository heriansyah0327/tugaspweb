    ...
    <main>
        ...
        <form action="" class="form" method="POST">
            <div class='form-input'>
                ...
                <input type='text' name="nama" placeholder='Masukkan Nama' class='form-input-size' required
                    id="name-label" />
            </div>
            <div class='form-input'>
                <label for='email-label'>Email</label>
                <input type='email' name="email" placeholder='Masukkan Email' class='form-input-size' required
                    id="email-label" />
            </div>
            <div class='form-input'>
                <label for='username-label'>Username</label>
                <input type='text' name='username' placeholder='Masukkan Username' class='form-input-size' required
                    id="username-label" />
            </div>
            <div class='form-input'>
                <label for='password-label'>Password</label>
                <input type='password' name='password' placeholder='Masukkan Password' class='form-input-size' required
                    id="password-label" />
            </div>
            <div class='form-input'>
